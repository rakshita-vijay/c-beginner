...
int calcTotalCost(int numberOfUnits)
{
    ...
    else
    {
        ...
        return (((for1To100Units.endingOfBlock)*(for1To100Units.costPerUnitForBlock)) + (((for101To400Units.endingOfBlock)-(for1To100Units.endingOfBlock))*(for101To400Units.costPerUnitForBlock)) + (((for401To700Units.endingOfBlock)-(for101To400Units.endingOfBlock))*(for401To700Units.costPerUnitForBlock)) + (numberOfUnits-for401To700Units.endingOfBlock)*(above700Units.costPerUnitForBlock));
    }
}
