...
float calcAverageRainfallPerMonthAcross5Years(int monthNumber, struct rainfall12M arrayRainfall[])
{
    ...
    if (monthNumber==0)
    {
        return((arrayRainfall[0].inch1 + arrayRainfall[1].inch1 + arrayRainfall[2].inch1 + arrayRainfall[3].inch1 + arrayRainfall[4].inch1)/5);
    }
    else if (monthNumber==1)
    {
        return((arrayRainfall[0].inch2 + arrayRainfall[1].inch2 + arrayRainfall[2].inch2 + arrayRainfall[3].inch2 + arrayRainfall[4].inch2)/5);
    }
    else if (monthNumber==2)
    {
        return((arrayRainfall[0].inch3 + arrayRainfall[1].inch3 + arrayRainfall[2].inch3 + arrayRainfall[3].inch3 + arrayRainfall[4].inch3)/5);
    }
    else if (monthNumber==3)
    {
        return((arrayRainfall[0].inch4 + arrayRainfall[1].inch4 + arrayRainfall[2].inch4 + arrayRainfall[3].inch4 + arrayRainfall[4].inch4)/5);
    }
    else if (monthNumber==4)
    {
        return((arrayRainfall[0].inch5 + arrayRainfall[1].inch5 + arrayRainfall[2].inch5 + arrayRainfall[3].inch5 + arrayRainfall[4].inch5)/5);
    }
    else if (monthNumber==5)
    {
        return((arrayRainfall[0].inch6 + arrayRainfall[1].inch6 + arrayRainfall[2].inch6 + arrayRainfall[3].inch6 + arrayRainfall[4].inch6)/5);
    }
    else if (monthNumber==6)
    {
        return((arrayRainfall[0].inch7 + arrayRainfall[1].inch7 + arrayRainfall[2].inch7 + arrayRainfall[3].inch7 + arrayRainfall[4].inch7)/5);
    }
    else if (monthNumber==7)
    {
        return((arrayRainfall[0].inch8 + arrayRainfall[1].inch8 + arrayRainfall[2].inch8 + arrayRainfall[3].inch8 + arrayRainfall[4].inch8)/5);
    }
    else if (monthNumber==8)
    {
        return((arrayRainfall[0].inch9 + arrayRainfall[1].inch9 + arrayRainfall[2].inch9 + arrayRainfall[3].inch9 + arrayRainfall[4].inch9)/5);
    }
    else if (monthNumber==9)
    {
        return((arrayRainfall[0].inch10 + arrayRainfall[1].inch10 + arrayRainfall[2].inch10 + arrayRainfall[3].inch10 + arrayRainfall[4].inch10)/5);
    }
    else if (monthNumber==10)
    {
        return((arrayRainfall[0].inch11 + arrayRainfall[1].inch11 + arrayRainfall[2].inch11 + arrayRainfall[3].inch11 + arrayRainfall[4].inch11)/5);
    }
    else
    {
        return((arrayRainfall[0].inch12 + arrayRainfall[1].inch12 + arrayRainfall[2].inch12 + arrayRainfall[3].inch12 + arrayRainfall[4].inch12)/5);
    }
    */
}
...
void printAverageRainfallPerMonthAcross5Years(char months[], struct rainfall12M arrayRainfall[])
{
    ...
    for(int monthNumber = 0; monthNumber < 12; monthNumber++)
    {
        ...
        // (averagePerMonthAcross5Years[monthNumber]<10) ? printf("0%.2f  ", averagePerMonthAcross5Years[monthNumber]) : printf("%.2f  ", averagePerMonthAcross5Years[monthNumber]);
...
int main()
{
    ...
    struct rainfall12M year2k3 = {4.5, 5.6, 6.7, 7.8, 8.9, 9.10, 10.11, 11.12, 12.13, 13.14, 14.15, 15.16}; //type: struct
