...
char check_W_Left(char grid[][], int rowNumber, int columnChoice) {
...
char check_E_Right(char grid[][], int rowNumber, int columnChoice) {
  if ((grid[rowNumber][columnChoice] == grid[rowNumber][columnChoice + 1]) && (grid[rowNumber][columnChoice] == grid[rowNumber][columnChoice + 2]) && (grid[rowNumber][columnChoice] == grid[rowNumber][columnChoice + 3])) {
    return 'w';
  }
...
char check_N_Top(char grid[][], int rowNumber, int columnChoice) {
...
char check_S_Down(char grid[][], int rowNumber, int columnChoice) {
  if ((grid[rowNumber][columnChoice] == grid[rowNumber + 1][columnChoice]) && (grid[rowNumber][columnChoice] == grid[rowNumber + 2][columnChoice]) && (grid[rowNumber][columnChoice] == grid[rowNumber + 3][columnChoice])) {
    return 'w';
  }
...
char check_NW(char grid[][], int rowNumber, int columnChoice) {
...
char check_NE(char grid[][], int rowNumber, int columnChoice) {
  if ((grid[rowNumber][columnChoice] == grid[rowNumber - 1][columnChoice + 1]) && (grid[rowNumber][columnChoice] == grid[rowNumber - 2][columnChoice + 2]) && (grid[rowNumber][columnChoice] == grid[rowNumber - 3][columnChoice + 3])) {
    return 'w';
  }
...
char check_SW(char grid[][], int rowNumber, int columnChoice) {
  if ((grid[rowNumber][columnChoice] == grid[rowNumber + 1][columnChoice - 1]) && (grid[rowNumber][columnChoice] == grid[rowNumber + 2][columnChoice - 2]) && (grid[rowNumber][columnChoice] == grid[rowNumber + 3][columnChoice - 3])) {
    return 'w';
  }
...
char check_SE(char grid[][], int rowNumber, int columnChoice) {
  if ((grid[rowNumber][columnChoice] == grid[rowNumber + 1][columnChoice + 1]) && (grid[rowNumber][columnChoice] == grid[rowNumber + 2][columnChoice + 2]) && (grid[rowNumber][columnChoice] == grid[rowNumber + 3][columnChoice + 3])) {
    return 'w';
  }
...
char checkIfPlayerHasWon(char grid[][], int rowNumber, int columnChoice) {
...
char markChoiceOnGrid(char rows[], char columns[], char grid[][], int columnChoice, char playerNumber) {
  ...
  for (int rowNumber = 0; grid[rowNumber][columnChoice] != '\0'; rowNumber++) {
